...
import topic_1.key1.payment.FinancialPayment;
import java.util.List;

import topic_1.key6.IObserver;
import topic_1.key6.MailingList;
import topic_1.key6.EMail;
...
public class EcommerceService {
	...
	public String listItems(){
		StringBuffer list=new StringBuffer();
		for (Product product : productListOffer) {
			list.append(product.getName()).append("...").append(product.getPrice()).append("$\n");
		}
		System.out.println(list);
		return list.toString();
	}
